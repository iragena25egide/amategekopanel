      ...
      <Card className="w-2/3 bg-white shadow-lg" style={{ height: '545px' }}>
        ...
        {activeTab === 'overview' && (
          <div className="p-8" style={{ marginTop: '-20px' }}>
            <h2 className="text-3xl font-semibold mb-4 text-gray-500">Sub Admin <span style={{ color: '#1890ff' }}>Overview</span></h2>
            <p className="mb-4 text-gray-500">Welcome to the Sub admin panel courses,quizes and platform settings from here.</p>
